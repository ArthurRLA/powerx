...
@Component
public class YouCardOrderStrategy implements OrderStrategy<Incentive>{

	private final XLSXOrderFactory orderFactory;
	
	@Autowired
	public YouCardOrderStrategy(XLSXOrderFactory orderFactory) {
		this.orderFactory = orderFactory;
	}
	
	@Override
	public XLSXReportDefinition<Incentive> definition(){
		return orderFactory.youCardOrderDefinition();
	}
