...
@Component
public class SwileOrderStrategy implements OrderStrategy<Incentive>{

	private final XLSXOrderFactory orderFactory;
	
	@Autowired
	public SwileOrderStrategy(XLSXOrderFactory orderFactory) {
		this.orderFactory = orderFactory;
	}
	
	@Override
	public XLSXReportDefinition<Incentive> definition(){
		return orderFactory.swileOrderDefinition();
	}
